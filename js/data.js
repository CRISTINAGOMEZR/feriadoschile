...
const ACTIVIDADES=[
  {nombre:'Valle de la Luna al atardecer',desc:'Formaciones de sal y roca talladas por el viento que brillan en tonos naranjas y rojos cuando el sol se pone. Una experiencia visual única.',ubicacion:'San Pedro de Atacama',cat:'naturaleza',temporada:'todo-el-año',url:'https://chileestuyo.cl/destino/san-pedro-de-atacama/'},
  {nombre:'Géiseres del Tatio al amanecer',desc:'El campo geotermal más alto del mundo a 4.320 m.s.n.m.: decenas de fumarolas estallan en vapor bajo temperaturas bajo cero.',ubicacion:'San Pedro de Atacama',cat:'naturaleza',temporada:'todo-el-año',url:'https://chileestuyo.cl/destino/san-pedro-de-atacama/'},
  {nombre:'Astroturismo en el Valle del Elqui',desc:'El cielo más despejado del planeta con más de 40 observatorios. Galaxias y la Vía Láctea a simple vista en una noche que cambia la perspectiva.',ubicacion:'Valle del Elqui, Coquimbo',cat:'naturaleza',temporada:'todo-el-año',url:'https://chileestuyo.cl/destino/observatorios-astronomicos-en-el-valle-de-elqui-y-coquimbo-2/'},
  {nombre:'Trekking en Torres del Paine',desc:'Glaciares, lagunas turquesas y las icónicas torres de granito en uno de los parques más espectaculares del mundo. El circuito W es la ruta clásica.',ubicacion:'Puerto Natales, Magallanes',cat:'aventura',temporada:'verano',url:'https://chileestuyo.cl/que-hacer/deporte-y-aventura/'},
  {nombre:'Ski y snowboard en los Andes',desc:'A 45 minutos de Santiago, Valle Nevado y Portillo ofrecen más de 100 pistas con nieve garantizada y vistas que cortan el aliento.',ubicacion:'Cordillera, Región Metropolitana',cat:'montana',temporada:'invierno',url:'https://chileestuyo.cl/que-hacer/deporte-y-aventura/'},
  {nombre:'Termas en los Siete Lagos',desc:'Aguas termales naturales rodeadas de volcanes nevados, bosques nativos y lagos cristalinos en la zona lacustre más hermosa del sur.',ubicacion:'Siete Lagos, Los Ríos',cat:'naturaleza',temporada:'todo-el-año',url:'https://chileestuyo.cl/itinerarios/rompe-la-rutina-en-el-destino-siete-lagos-entre-volcanes-y-aguas-termales/'},
  {nombre:'Saltos del Petrohué',desc:'Las aguas turquesas del río Petrohué se precipitan entre rocas volcánicas negras con el volcán Osorno de fondo. Un paisaje de postal.',ubicacion:'Puerto Varas, Los Lagos',cat:'naturaleza',temporada:'primavera',url:'https://www.tripadvisor.cl/Attraction_Review-g303697-d530959-Reviews-Saltos_del_Petrohue-Puerto_Varas_Los_Lagos_Region.html'},
  {nombre:'Barrio Lastarria y La Chascona',desc:'El barrio más bohemio de Santiago con cafés, galerías y librerías. Visita la casa museo de Pablo Neruda, declarada Monumento Nacional.',ubicacion:'Santiago',cat:'cultura',temporada:'todo-el-año',url:'https://santiagosecreto.com/que-hacer-el-fin-de-semana-en-santiago/'},
  {nombre:'Cerro San Cristóbal',desc:'El gran pulmón verde de Santiago: caminatas panorámicas, teleférico y picnic con atardecer andino. Uno de los parques urbanos más grandes del mundo.',ubicacion:'Santiago',cat:'ciudad',temporada:'todo-el-año',url:'https://www.tripadvisor.cl/Attraction_Review-g294305-d317613-Reviews-Cerro_San_Cristobal-Santiago_Santiago_Metropolitan_Region.html'},
  {nombre:'Tour y cata en viña Cousiño Macul',desc:'Fundada en 1856, esta viña familiar en Santiago tiene bodegas centenarias con toneles históricos. Tour + cata de vinos premiados.',ubicacion:'Santiago',cat:'gastronomia',temporada:'todo-el-año',url:'https://www.tripadvisor.cl/Attraction_Review-g294305-d591917-Reviews-Cousino_Macul_Winery-Santiago_Santiago_Metropolitan_Region.html'},
  ...
  {nombre:'Ruta del pisco artesanal',desc:'Destilerías con uvas moscatel cultivadas bajo el sol del desierto. Catas, tours de producción y paisaje de viñedos en el valle del Elqui.',ubicacion:'Pisco Elqui, Coquimbo',cat:'gastronomia',temporada:'otono',url:'https://chileestuyo.cl/turismo-gastronomico/'},
  {nombre:'Surf en la costa araucana',desc:'Olas consistentes y playas de arena negra volcánica en Mehuín y Pucatrihue. Destinos secretos para surfistas que buscan alejarse de las multitudes.',ubicacion:'Costa de La Araucanía',cat:'playa',temporada:'verano',url:'https://chileestuyo.cl/que-hacer/deporte-y-aventura/'},
  {nombre:'Rapa Nui: moáis y cultura viva',desc:'La isla más remota del Pacífico, hogar de los enigmáticos moáis y de una cultura que celebra el festival Tapati cada verano.',ubicacion:'Isla de Pascua',cat:'cultura',temporada:'verano',url:'https://chileestuyo.cl/destino/rapa-nui/'},
  {nombre:'Sandboard en dunas de Atacama',desc:'Deslízate por dunas de hasta 150 metros en el desierto más árido del planeta. Adrenalina pura en el paisaje más fotogénico de Chile.',ubicacion:'Región de Atacama',cat:'aventura',temporada:'todo-el-año',url:'https://chileestuyo.cl/que-hacer/deporte-y-aventura/'},
  {nombre:'Kayak en fiordos patagónicos',desc:'Rema entre glaciares y paredes de roca cubiertas de musgo en canales que solo se pueden explorar desde el agua. La Patagonia en su versión más íntima.',ubicacion:'Puerto Natales / Aysén',cat:'aventura',temporada:'verano',url:'https://chileestuyo.cl/que-hacer/deporte-y-aventura/'},
  {nombre:'Gastronomía mapuche en La Araucanía',desc:'Siéntate en una ruca y comparte un fogón con cocineras mapuche que preparan recetas milenarias con milcao y hierbas del bosque.',ubicacion:'La Araucanía',cat:'gastronomia',temporada:'todo-el-año',url:'https://chileestuyo.cl/turismo-gastronomico/'},
  {nombre:'Valparaíso: ascensores y murales',desc:'Funiculares a los cerros más coloridos del Pacífico y calles que son museo a cielo abierto con murales de artistas de todo el mundo.',ubicacion:'Valparaíso',cat:'cultura',temporada:'todo-el-año',url:'https://chileestuyo.cl/regiones/region-de-valparaiso/'},
  {nombre:'Playas de Viña y Algarrobo',desc:'El litoral central concentra playas urbanas y caletas de pescadores a menos de dos horas de Santiago. Sol, mariscos y buen clima.',ubicacion:'Viña del Mar / Algarrobo',cat:'playa',temporada:'verano',url:'https://chileestuyo.cl/destino/litoral-de-los-poetas/'},
  {nombre:'Volcán Villarrica: sube hasta el cráter',desc:'Con guía y equipo, puedes llegar al borde de uno de los volcanes más activos de Sudamérica (2.847 m) y ver la lava desde arriba.',ubicacion:'Pucón, La Araucanía',cat:'aventura',temporada:'verano',url:'https://chileestuyo.cl/que-hacer/deporte-y-aventura/'},
  {nombre:'Crucero por glaciares australes',desc:'Navega por fiordos, bosques de lengas e icebergs azules. La forma más épica de ver la Patagonia chilena desde Puerto Montt.',ubicacion:'Puerto Montt / Patagonia',cat:'naturaleza',temporada:'verano',url:'https://chileestuyo.cl/que-hacer/naturaleza/'},
  {nombre:'Birdwatching en los Humedales del Norte',desc:'Salares y humedales altiplánicos con flamencos rosados y más de 200 especies endémicas. El lago Chungará es un paraíso para el birdwatching.',ubicacion:'Arica y Parinacota',cat:'naturaleza',temporada:'otono',url:'https://chileestuyo.cl/itinerarios/vive-el-sincretismo-cultural-de-la-region-de-arica-y-parinacota/'},
  {nombre:'Sky Costanera: 300 metros de altura',desc:'Vista de 360° desde el edificio más alto de Latinoamérica: Santiago completo, la cordillera nevada y la costa en días despejados.',ubicacion:'Santiago',cat:'ciudad',temporada:'todo-el-año',url:'https://www.tripadvisor.cl/Attraction_Review-g294305-d2358967-Reviews-Sky_Costanera-Santiago_Santiago_Metropolitan_Region.html'},
  {nombre:'Mercado Central y caleta de pescadores',desc:'El mejor marisco de Santiago en el mercado histórico del centro. Combina con una mañana en el Barrio Italia o el Museo de Bellas Artes.',ubicacion:'Santiago',cat:'gastronomia',temporada:'todo-el-año',url:'https://santiagosecreto.com/que-hacer-el-fin-de-semana-en-santiago/'},
  {nombre:'Reserva Nacional Río Clarillo',desc:'Bosque esclerófilo nativo a 45 minutos de Santiago con senderos entre arrayanes y boldos. Ideal para un trekking accesible en día feriado.',ubicacion:'Pirque, Región Metropolitana',cat:'naturaleza',temporada:'primavera',url:'https://chileestuyo.cl/que-hacer/naturaleza/'}
];
